...
package com.artemis.media.filter.view;
...
/**
 * Created by ssh on 2019/11/27.
 * 修改自{@link android.opengl.GLSurfaceView} sdk 29
 * 更改点：
 * {@link #init}
 * {@link SimpleEGLConfigChooser}
 * {@link SurfaceTextureListener}接口的实现方法
 *
 * 设置背景透明相关方法
 * @see #setEGLContextClientVersion(int) 设置gl版本3
 * @see #setOpaque(boolean) 设置不透明false
 *
 */

public class GLTextureView extends TextureView implements TextureView.SurfaceTextureListener, IGLView {
    ...
    public boolean onSurfaceTextureDestroyed(SurfaceTexture surface) {
        ...
        return mSurfaceTextureListener == null || mSurfaceTextureListener.onSurfaceTextureDestroyed(surface);
    }

    @Override  //此方法在main thread被调用
